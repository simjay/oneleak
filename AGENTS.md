...
- **Test fixtures use fake-but-realistic values only** — `"sk-proj-" + "a" * 20`, never a real or even expired/revoked credential. This is enforced by convention, not tooling; don't break it.
